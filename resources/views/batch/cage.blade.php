...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transfer Batch into Cage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#" class="a-c-dm">Home</a></li>
              <li class="breadcrumb-item active">Transfer Batch into Cage</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <ul>
                    ...
                    <li><label> Tray No : I-123 </label> <br></li>
                  ...
                  <ul>
                    <li><label> Date of Birth : <b> 10-12-2020 </b> </label> <br></li>
                    <li><label> Brooder Start Date : 10-12-2020 </label> <br></li>
                    <li><label> Brooder No : B-2 </label> <br></li>
                    <li><label> Total Chicks : 50 </label> <br></li>
                    <li><label> Mortality (including pipped eggs) : 12 </label> <br></li>
                  </ul>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group" >
                        <label>Cage Number<span class="reg-form-err-span"> &nbsp; @error('cnic') {{ $message }} @enderror  </span> </label>
                    ...
                    <div class="col-md-4">
                      <div class="form-group" >
                        <label>Start Date<span class="reg-form-err-span"> &nbsp; @error('mobile') {{ $message }} @enderror  </span> </label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group" >
                        <label>Total<span class="reg-form-err-span"> &nbsp; @error('designation') {{ $message }} @enderror  </span> </label>
                    ...
                    <div class="col-md-4">
                      <div class="form-group" >
                        <label>Mortality <span class="reg-form-err-span"> &nbsp; @error('designation') {{ $message }} @enderror  </span> </label>
                        <input type="text" class="form-control" name="designation" id="designation" required>
                      </div>
                    </div>
